...
return array(
    ...
    'There is no start date or due date or end date for this task.' => 'Il n\'y a pas de date de début ou de date d\'échéance ou de date de fin pour cette tâche.',
    'Moving or resizing a task will change the start and due date of the task (or its end date if its already closed).' => 'Déplacer ou redimensionner une tâche va changer la date de début et la date d\'échéance de la tâche (ou sa date de fin si elle est fermée).',
